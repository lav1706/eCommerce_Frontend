const Register = () => {
  return (
    <div className="w-screen h-screen relative">
      ...
      />
      <div className="absolute z-30 w-full mobile:w-4/5 p-5 bg-blue-200 top-0 mobile:top-[15%] left-0 mobile:left-[10%] ">
        <h1 className="text-2xl font-light">CREATE AN ACCOUNT</h1>
        <form className="flex flex-wrap">
          <input
            placeholder="name"
            type="text"
            className="w-full mobile:flex-1 min-w-[40%] ml-0 mr-2.5 mt-5 mb-0 p-2.5"
          />
          <input
          ...
          <button className="w-full mobile:w-2/5 bg-[teal] text-[white] cursor-pointer px-5 py-[15px] border-[none]">
            CREATE
          </button>
        </form>
      </div>
